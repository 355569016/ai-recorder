...
let fileDetailContent = {
  ...
  transcript: [
    "我们先确认这次评审的目标，主要聚焦拼团营销工具的 MVP 范围。",
    "图片、标注和商品关联需要先做最小可用链路，复杂规则放到下一版。"
  ]
};
...
function persistFileDetailContentEdit(showNotice = false) {
  ...
  if (draft) {
    ...
    if (fileDetailContentEditor.kind === "transcript") {
      ...
      fileDetailContent.transcript[index] = draft;
    }
  }
  fileDetailContentEditor = null;
      ...
      <div class="file-detail-view" aria-label="文件详情内容">
        ...
        ` : activeTab === "transcript" ? `
          <section class="file-detail-section ai-section ${editingSection === "transcript" ? "is-editing-section" : ""}" data-detail-section="transcript" id="detail-transcript">
            <div class="transcript-line"><b>00:03</b>${renderFileDetailEditableContent("transcript", fileDetailContent.transcript[0], { key: "transcript-0", label: "00:03 转写内容", rows: 4 })}</div>
            <div class="transcript-line"><b>01:18</b>${renderFileDetailEditableContent("transcript", fileDetailContent.transcript[1], { key: "transcript-1", label: "01:18 转写内容", rows: 4 })}</div>
          </section>
        ` : `
...
document.addEventListener("click", (event) => {
  ...
  if (action && action.dataset.action === "file-detail-edit-content") {
    ...
    if (kind === "transcript") {
      ...
      draft = fileDetailContent.transcript[index] || "";
    }
    fileDetailFormatPanel = "main";
