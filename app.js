...
let fileDetailActiveTab = "outline";
...
const pages = [
  ...
  },
  {
    ...
    rules: ["开启同步云端时，标题优先根据云端同步数据提炼。", "未开启同步云端时，标题默认使用文件名称。", "生成 AI 会议摘要后，标题根据 AI 会议内容重新提炼总结。", "生成 AI 会议总结后，根据会议内容提取关键标签。", "播放器进度条支持点击和拖动调整音频进度。", "播放器控制区包含音频设置、快退 15 秒、播放、快进 15 秒、倍速，不展示额外方向箭头。", "播放器下方的大纲、智能总结、文字记录、标记、待办事项和思维导图为同一长页的内容锚点导航，不切换页面或替换内容；点击仅定位，滚动时自动关联高亮当前阅读区。", "录音中产生的文字、时间和照片标记在录音结束后完整继承到文件详情，不能依赖转写或 AI 生成状态。", "录音结束后不再允许新增标记，只能维护录音过程中已经产生的标记。", "点击标记时间或播放图标定位到对应音频时间并开始播放。", "点击标记文本、照片说明、文字记录或智能总结时，原文字直接出现光标并唤起系统键盘；不打开弹窗、新页面，不增加边框、下划线、取消或保存按钮。", "智能总结和文字记录使用系统键盘上方的轻量格式工具栏，至少包含标题/正文、列表、对齐、引用、撤销和重做；普通标记与照片说明保持纯文本键盘，不展示格式工具栏。", "编辑内容实时记录，输入框失焦、收起键盘或跳转其他内容锚点时自动保存。", "照片可打开和删除；标记时间与来源保持只读。", "生成 AI 内容时读取当时的标记快照作为辅助笔记；生成后继续编辑标记不会静默改写既有 AI 内容，重新生成时再读取最新标记。", "页面底部固定展示对此笔记提问输入框。", "右上角分享按钮打开分享弹窗，三个点打开更多操作浮层。"],
    states: ["标记页签", "标记原位编辑", "转写原位编辑", "总结原位编辑", "照片预览", "未生成 AI 摘要", "AI 已生成", "音频设置", "倍速选择", "分享", "更多操作", "文件损坏", "删除确认"],
    deps: ["本地播放器：进度、跳转、快退快进、倍速。", "音频分析：静音/无声片段识别。", "转写服务：文字记录和时间戳。", "本地数据库：录音标记、备注、照片附件。", "AI 服务：标题、标签、大纲、总结、待办、思维导图、笔记问答。", "云端分享：分享链接和权限。"],
    acceptance: ["播放器下方必须有大纲、智能总结、文字记录、标记、待办事项、思维导图的横向锚点导航，六个内容区在同一长页连续展示。", "点击导航项仅平滑定位；向下滚动时当前阅读内容区自动高亮，且当前项保持可见。", "录音期间的全部标记在已生成文件详情中完整展示，并标注已用于本次生成、可继续编辑。", "录音结束后的文件详情不得出现新增标记入口。", "点击标记时间定位音频；点击标记内容、文字记录和智能总结均在原文字位置直接输入，仅显示光标和系统键盘，不出现独立窗口或显式保存操作。", "总结和转写编辑时格式栏可切换标题、列表、对齐和引用；标记编辑时不显示格式栏。", "失焦、收起键盘或跳转其他内容锚点后内容自动保存。", "照片可查看或删除，时间与来源只读。", "思维导图按卡片预览呈现。", "音频设置和倍速按钮能打开对应弹窗。", "底部有对此笔记提问输入框。", "标题和标签规则在字段与交互说明中明确。"],
  ...
  },
  {
    ...
    rules: ["文件列表和文件详情为空的生成入口必须先进入本页。", "点击立即生成后进入文件详情生成中页面。", "自动生成自动匹配转写模板与总结。", "自定义生成可调整模板、说话人、语言和 AI 模型。", "额度不足时立即生成按钮置灰并禁止提交。", "弹层打开时底层文件详情整体进入同一蒙版状态，包括吸顶的大纲、智能总结、文字记录等导航。", "页面不重复展示录音场景，也不在按钮上方展示云端上传说明。"],
  ...
  },
  {
    ...
    deps: ["转写服务语言列表。"],
    acceptance: ["当前语言有清晰勾选态。", "底层大纲、智能总结、文字记录等导航不得穿透蒙版。", "点击任一语言后返回转写与生成页面。"]
  },
  {
    id: "APP-AI-03",
    group: "AI",
    ...
    deps: ["AI 服务模型列表与可用状态。"],
    acceptance: ["当前模型有清晰勾选态。", "底层大纲、智能总结、文字记录等导航不得穿透蒙版。", "点击任一模型后返回转写与生成页面。"]
  },
  {
    id: "APP-ME-02",
    group: "我的",
  ...
  return `
    <section class="ask-thinking">
      ...
      <div class="ask-thinking-copy" data-action="ask-complete-thinking">
        <p>深度思考中 <span>⌃</span></p>
        <b>提取关键见解</b>
        <p>我目前正在仔细研读这份文字记录，重点在于提炼出 3 到 5 条与制造业演示相关的关键见解。我的工作流程包括仔细阅读并理解讨论的核心内容。</p>
        <b>提炼核心要点</b>
...
function renderFileDetailMarkers(markerState = "pending") {
  const markerStatus = markerState === "generated"
    ? "已用于本次生成，可继续编辑"
    : markerState === "generating"
      ? "本次生成已读取，后续修改将在下次生成时使用"
      : "将在生成时作为辅助笔记";
  return `
    <section class="file-markers-panel" aria-label="文件标记">
      <header class="file-markers-head">
        <div>
          <h2>标记</h2>
...
function renderFileDetailTabs(state = "generated") {
  const tabs = state === "generated"
    ? [["大纲", "outline"], ["智能总结", "summary"], ["文字记录", "transcript"], ["标记", "markers"], ["待办事项", "todos"], ["思维导图", "mindmap"]]
    : [["标记", "markers"], ["总结", "summary"]];
  return `
    <nav class="file-detail-tabs" aria-label="文件详情内容锚点导航">
...
function renderFileDetail() {
  const activeTab = ["outline", "summary", "transcript", "markers", "todos", "mindmap"].includes(fileDetailActiveTab) ? fileDetailActiveTab : "outline";
  ...
  return `
    ...
    <main class="file-detail-page ${fileDetailMarkerEditor || contentEditing ? "is-editing" : ""} ${contentEditing ? "is-rich-editing" : ""}">
      ...
      <div class="file-detail-sections" aria-label="文件详情内容">
      <section class="file-detail-section ai-section outline-section" data-detail-section="outline" id="detail-outline">
      ...
      <section class="file-detail-section ai-section ${editingSection === "summary" ? "is-editing-section" : ""}" data-detail-section="summary" id="detail-summary">
        <h2>智能总结</h2>
        <h3>录音信息</h3>
        ...
        <h3>录音总结</h3>
        ${renderFileDetailEditableContent("summary", fileDetailContent.summary, { label: "录音总结", rows: 6 })}
      </section>
      ...
      <section class="file-detail-section ai-section" data-detail-section="todos" id="detail-todos">
        <h2>待办事项</h2>
      ...
      <section class="file-detail-section ai-section mindmap-section" data-detail-section="mindmap" id="detail-mindmap">
...
function render() {
  ...
  renderSpec(page);
  if (page.id === "APP-FILE-01") setupFileDetailSectionSpy();
}

function setFileDetailActiveSection(value) {
  if (!["outline", "summary", "transcript", "markers", "todos", "mindmap"].includes(value) || fileDetailActiveTab === value) return;
  fileDetailActiveTab = value;
  const nav = document.querySelector(".file-detail-tabs");
  const activeButton = nav?.querySelector(`[data-value="${value}"]`);
...
function setupFileDetailSectionSpy() {
  ...
  const update = () => {
    ...
    const targetLine = containerTop + 132;
    let active = sections[0];
    sections.forEach((section) => {
      if (section.getBoundingClientRect().top <= targetLine) active = section;
    });
    setFileDetailActiveSection(active.dataset.detailSection);
  };
  scroller.addEventListener("scroll", update, { passive: true });
  requestAnimationFrame(update);
}

function scrollFileDetailToSection(target, behavior = "smooth") {
  const scroller = document.querySelector(".file-detail-page");
  const section = document.querySelector(`[data-detail-section="${target}"]`);
  if (!scroller || !section) return false;
  const navHeight = document.querySelector(".file-detail-tabs")?.offsetHeight || 54;
  const nextTop = Math.max(0, scroller.scrollTop + section.getBoundingClientRect().top - scroller.getBoundingClientRect().top - navHeight - 10);
  if (typeof scroller.scrollTo === "function") scroller.scrollTo({ top: nextTop, behavior });
...
document.addEventListener("click", (event) => {
  ...
  if (action && action.dataset.action === "file-detail-set-tab") {
    ...
    const target = action.dataset.value || "outline";
    setFileDetailActiveSection(target);
    if (currentPageId !== "APP-FILE-01") {
      render();
      return;
    }
    scrollFileDetailToSection(target);
    return;
  }
  ...
  if (action && action.dataset.action === "file-detail-edit-content") {
    ...
    if (currentPageId === "APP-FILE-01") fileDetailActiveTab = kind;
    render();
    requestAnimationFrame(() => {
      if (currentPageId === "APP-FILE-01") scrollFileDetailToSection(kind, "auto");
      focusFileDetailEditor("fileDetailContentInput");
    });
    return;
  }
